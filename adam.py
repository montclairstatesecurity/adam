...
answers = ['Did you try turning it off and on?', 
           'Blame Networking.', 
           'Have you tried Googling the error code?',
           'Try reading the documentation.', 
           'Take a short break and try again.',
           'Get some coffee and try again.', 
           'Maybe you\'re hungry? Take a break.', 
           'Try meditation.',
           'Unplug the machine.',
           'Delete everything on the machine.', 
           'Wipe the hard drive.',
           'Find an open window and throw the machine out of it.', 
           'It works better hacked.',
           'Sorry, I\'m on vacation in Flavortown right now.', 
           ...
           'Flavortown is near.', 
           'It\'s "Bomgar", not "Bombguard"',
           'Let me run this up the flagpole to management and see what they think.',
           'Waiting for leadership...', 
           'I don\'t have any cycles left to solve that problem.',
           'Restart the domain controllers', 
           'Get military grade EDR.', 
           'Try whitelisting it.', 
           'Make a dashboard.', 
           'Find $2 Billion in synergies.', 
           'Call Cognizant', 
           'Machine Learning!',
           'The adversary is China.', 
           'Try using Threatbutt.', 
           'Watch \"Hackers\" three times, then try again.']
